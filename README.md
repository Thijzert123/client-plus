...
- ~~Update packwiz_update.py to update Vanilla Tweaks resource packs by downloading using the links~~ Done, but now make it work for the 1.20.x versions
